import com.javarush.hayriyan.hibernate.dao.*;
import com.javarush.hayriyan.hibernate.entity.*;
...
public class Main {
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            filmText.setDescription("good film");
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()){
            ...
            Store store =  storeDAO.getItems(0,1).get(0);
            City city = cityDAO.getByName("Zaria");


            Address address  = new Address();
            address.setAddress("test address");
            address.setPhone("111-1111-1111");
            address.setCity(city);
            address.setDistrct("District 1");
